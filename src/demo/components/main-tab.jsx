            ...
            <div className="panels">
                <div className="main-stats-wrapper">
                    <div className='main-stats flex'>
                        {
                            <div className={player ? "flex-col" : "full-width-stats"}>
                                <StatsList 
                                    positions={positions}
                                    player={player}
                ...
                {
                    Miscellaneous && (
                        <div className={`${displayMiscMainSize ? "main-stats-wrapper" : "misc-stats"} flex-col`}>
                ...
                {
                    Ratios && (          
                        <div className={`${displayMiscMainSize ? "main-stats-wrapper" : "ratio-stats"} flex-col`}>
