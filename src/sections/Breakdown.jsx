        ...
        <section className='leaderboard-overview'>
            ...
            <div className="overview-highlight-row second">
                ...
                <div class="stat-tracker-player-data">
                    ...
                    <div class="stat-tracker-mod-rows">
                        <div class="stat-tracker-mod-row top-position-3 pos-1">
                            <div class="position-col">
                                <span>1</span>
                            </div>
                            <div class="account-col">
                        ...
                        <div class="stat-tracker-mod-row top-position-3 pos-2">
                            <div class="position-col">
                                <span>2</span>
                            </div>
                            <div class="account-col">
                        ...
                        <div class="stat-tracker-mod-row top-position-3 pos-3">  
                            <div class="position-col">
                                <span>3</span>
                            </div>
                            <div class="account-col">
...
const StatsDisplay = () => (
    ...
    <div class="main-stats-wrapper">
        <div class="main-stats flex">
            <div class="flex-col flex-1 flex">
            <div class="profile-stats-wrapper">
                <span class="profile-stats top-position-1">
                <span>
                    <span class="value-pos-row">
                ...
                <span class="profile-stats top-position-2">
                <span>
                    <span class="value-pos-row">
                ...
                <span class="profile-stats top-position-3">
                <span>
                    <span class="value-pos-row">
                ...
                <span class="profile-stats duration-col top-position-1">
                <span>
                    <span class="value-pos-row">
    ...
    <>
        ...
        <div className="overview-highlight-row second">
            ...
            <div className="head-to-head-stats">
                <div class="profile-stats-wrapper">
                    <span class="player-comparison-stats Weapons-stats">
                        <span class="flex">
...
const StatsTrackerBreakdown = () => (
    <section className="content-section">
        <article className="text-lg">
            <h2>Gaming Stats Tracker and Leaderboards project</h2>
            <h4>2021 - Now</h4>
            <section>
                ...
                <p>All sections below show data from the Halo 5 project rebuilt using the Stats Tracker, which you can view on the <Link to="/demo/rating">demo page</Link>.</p>
            </section>
            <LeaderboardSnippet />
            <section>
            ...
            <section>
                ...
                <article>
                    <div className="badge-overview">
                        <section className="info">
                            <p><u>Simple Player Data Badges</u></p>
                    ...
                    <div className="badge-overview">
                        <section className="info">
                            <p><u>Custom Player Data Badge</u></p>
            ...
            <section className="mt-10">
                <h2>Halo 5 Stats Tracker: Comparing Players</h2>
